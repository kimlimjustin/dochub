...
import type { CustomTheme, Theme } from "../../Typings/theme";
...
// prettier-ignore
const CATEGORIES = ["root", "windowmanager", "tabs", "settings", "favorites", "grid", "contextmenu", "prompt", "preview", "properties"];
